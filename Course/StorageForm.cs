    ...
    public partial class StorageForm : Form
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                DGVresize.Set(dataGridView1);
                DGVresize.Set(dataGridView2);
            }
            catch (Exception ex)
            {
        ...
        {
            sqlConnection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\жопа\Downloads\cours-main\cours-main\Course\Database1.mdf;Integrated Security=True");
            sqlConnection.Open();
